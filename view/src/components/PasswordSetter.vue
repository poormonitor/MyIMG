...
<template>
    <el-dialog v-model="visible" title="Set Password" class="w-4/5 md:3/5 lg:w-2/5">
        <el-form :rules="rules" :model="passwdSet" ref="form" label-width="33%" :inline-message="true">
            <div class="m-8">
                <el-form-item label="Origin Password" prop="old">
                    <el-input placeholder="Origin Password" v-model="passwdSet.old" type="password"
                        autocomplete="current-password">
                    </el-input>
                </el-form-item>
                <el-form-item label="New Password" prop="new">
                    <el-input placeholder="New Password" v-model="passwdSet.new" type="password"
                        autocomplete="new-password">
                    </el-input>
                </el-form-item>
                <el-form-item label="Repeat Password" prop="repeat">
                    <el-input placeholder="Repeat Password" v-model="passwdSet.repeat" type="password"
                        @enter="submitRequest" autocomplete="new-password">
                    </el-input>
                </el-form-item>
            </div>
        </el-form>
